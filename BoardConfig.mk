...
TW_BACKUP_EXCLUSIONS := /data/fonts;/data/adb/ksu
TW_FRAMERATE := 90
TW_Y_OFFSET := 90
TW_H_OFFSET := -90
...
FOX_DEVICE := umi
FOX_RECOVERY_SYSTEM_DEVICE := umi
FOX_RECOVERY_SYSTEM_MODEL := "Xiaomi Mi 10"
FOX_RECOVERY_SYSTEM_BRAND := Xiaomi
FOX_RECOVERY_VENDOR_DEVICE := umi
FOX_RECOVERY_VENDOR_MODEL := "Xiaomi Mi 10"
FOX_RECOVERY_VENDOR_BRAND := Xiaomi
FOX_RECOVERY_ODM_DEVICE := umi
FOX_RECOVERY_ODM_MODEL := "Xiaomi Mi 10"
